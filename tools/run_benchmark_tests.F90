...
program run_benchmark_tests
    ...
    call mpp_init()
    write(*,*) 'FV3 Tracer Transport Optimization Benchmark Suite'
    write(*,*) '================================================='
    ...
    call mpp_sync()
    write(*,*) 'Benchmark tests completed successfully.'
...
end program run_benchmark_tests